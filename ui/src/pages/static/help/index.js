            ...
            <ul className="nav nav-list">
              ...
              <li><a href="#mobile">Mobile Devices</a></li>
	    		...
	    		<div className="col-md-9 col-sm-12">
						...
						<iframe width="560" height="315" title="factile introduction" src="http://www.youtube.com/embed/IXgl27L6mo4" frameBorder="0" allowFullScreen></iframe>
						<div>
						  	<div>
						      ...
						      <div className="clearfix" id="manage">&nbsp;</div>
						  		...
						  		<p>You can view/ edit a survey, review its responses or delete just the responses/ the questionnaire as well from the dashboard.</p>
